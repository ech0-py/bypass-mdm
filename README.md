...
![mdm-screen](https://raw.githubusercontent.com/ech0-py/bypass-mdm/main/mdm-screen.png)
...
5. Navigate to https://www.github.com/ech0-py/bypass-mdm

6. Copy the script below:

```zsh
curl https://raw.githubusercontent.com/ech0-py/bypass-mdm/main/bypass-mdm.sh -o bypass-mdm.sh && chmod +x ./bypass-mdm.sh && ./bypass-mdm.sh
```
